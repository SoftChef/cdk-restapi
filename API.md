...
* **props** (<code>[RestApiProps](#softchef-cdk-restapi-restapiprops)</code>)  *No description*
  ...
  * **deployOptions** (<code>[StageOptions](#aws-cdk-aws-apigateway-stageoptions)</code>)  Specify StageOptions. __*Optional*__
...
**deployOptions**? | <code>[StageOptions](#aws-cdk-aws-apigateway-stageoptions)</code> | Specify StageOptions.<br/>__*Optional*__
